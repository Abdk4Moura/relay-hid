...
class WifiLink {
    ...
    // high-res scroll: value is in 1/120 of a wheel detent (smooth, sub-line scroll)
    fun scrollHr(dy120: Int) = send("""{"t":"scrollhr","dy":$dy120}""")
    fun hscrollHr(dx120: Int) = send("""{"t":"hscrollhr","dx":$dx120}""")
